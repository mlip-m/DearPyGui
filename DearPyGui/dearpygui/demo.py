    ...
    with window("Dear PyGui Demo", x_pos=100, y_pos=100, width=800, height=800, on_close=on_demo_close):
        ...
        with collapsing_header("Widgets##demo"):
            ...
            with tree_node("Basic##demo"):
                ...
                add_button("mvThemeCol_Button",callback = lambda sender, data: set_global_color(mvThemeCol_Button, [0,0,0,255]))
                add_button("mvThemeCol_ButtonHovered",callback = lambda sender, data: set_global_color(mvThemeCol_ButtonHovered, [250,250,250,255]))
                add_button("mvThemeCol_ButtonActive",callback = lambda sender, data: set_global_color(mvThemeCol_ButtonActive, [175,175,175,255]))
